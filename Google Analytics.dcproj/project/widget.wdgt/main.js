...
function applystyle()
{
    ...
    1. white          Anthony - google analytics-like skin
    2. Dark (default) Anthony - Default (looks nice on dark dashboard)
...
function updaterchekc(event)
{
    ...
    updaterrequest.open("GET", "http://aantthony.github.com/analytics-widget/version.txt");
...
function downloadnewversion(){
    if(window.widget)
    {
        //Showing the source code when someone simply wants to update might be a bit annoying
        // but it will have to do until a page is created.
        widget.openURL("https://github.com/aantthony/analytics-widget");
    }
}
